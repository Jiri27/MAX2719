...
; genLabel
00102$:
;	./src/main.c: 88: vysledek = number1/100;
; genCast
; genAssign
	ldw	y, (0x0e, sp)
	ldw	(0x0b, sp), y
...
; genCast
; genAssign
;	./src/main.c: 89: display(DIGIT6, vysledek);
; genIPush
	push	a
; genSend
	ld	a, #0x07
...
; genCast
; genAssign
;	./src/main.c: 92: display(DIGIT5, vysledek1);
; genIPush
	push	a
; genSend
	ld	a, #0x06
...
; genCast
; genAssign
;	./src/main.c: 94: display(DIGIT4, n);
; genCast
; genAssign
; genIPush
	push	a
...
; genCall
	call	_display
;	./src/main.c: 95: number1 ++;
; genPlus
	ldw	x, (0x0e, sp)
	incw	x
	ldw	(0x0e, sp), x
00142$:
;	./src/main.c: 97: if(number1>999){
; genCast
; genAssign
	ldw	x, (0x0e, sp)
; genCmp

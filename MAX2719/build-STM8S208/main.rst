      ...
      0082E0 93               [ 1]  527 	ldw	x, y
                                    ...
                                    532 ; genAssign
                                    533 ; genDivMod
      0082E1 4F               [ 1]  534 	clr	a
      0082E2 95               [ 1]  535 	ld	xh, a
      0082E3 A6 0A            [ 1]  536 	ld	a, #0x0a
      0082E5 62               [ 2]  537 	div	x, a
      0082E6 9F               [ 1]  538 	ld	a, xl
                                    539 ; genCast
                                    540 ; genAssign
                                    541 ;	./src/main.c: 92: display(DIGIT5, vysledek1);
                                    542 ; genIPush
      0082E7 88               [ 1]  543 	push	a
                                    544 ; genSend
      0082E8 A6 06            [ 1]  545 	ld	a, #0x06
                                    546 ; genCall
      0082EA CD 81 86         [ 4]  547 	call	_display
                                    548 ;	./src/main.c: 93: n= number1%10;
                                    549 ; genDivMod
      0082ED 1E 0B            [ 2]  550 	ldw	x, (0x0b, sp)
      0082EF 90 AE 00 0A      [ 2]  551 	ldw	y, #0x000a
      0082F3 65               [ 2]  552 	divw	x, y
      0082F4 90 9F            [ 1]  553 	ld	a, yl
                                    554 ; genCast
                                    555 ; genAssign
                                    556 ; genCast
                                    557 ; genAssign
                                    ...
                                    560 ; genAssign
                                    561 ; genIPush
      0082F6 88               [ 1]  562 	push	a
                                    563 ; genSend
      0082F7 A6 05            [ 1]  564 	ld	a, #0x05
                                    565 ; genCall
      0082F9 CD 81 86         [ 4]  566 	call	_display
                                    567 ;	./src/main.c: 95: number1 ++;
                                    568 ; genPlus
      0082FC 1E 0E            [ 2]  569 	ldw	x, (0x0e, sp)
      0082FE 5C               [ 1]  570 	incw	x
      0082FF 1F 0E            [ 2]  571 	ldw	(0x0e, sp), x
      008301                        572 00142$:
                                    573 ;	./src/main.c: 97: if(number1>999){
                                    574 ; genCast
                                    575 ; genAssign
      008301 1E 0E            [ 2]  576 	ldw	x, (0x0e, sp)
                                    577 ; genCmp
                                    578 ; genCmpTnz
      008303 A3 03 E7         [ 2]  579 	cpw	x, #0x03e7
      008306 22 03            [ 1]  580 	jrugt	00143$
      008308 CC 82 81         [ 2]  581 	jp	00108$
      00830B                        582 00143$:
                                    583 ; skipping generated iCode
                                    584 ;	./src/main.c: 98: number1 = 0;
                                    585 ; genAssign
      00830B 5F               [ 1]  586 	clrw	x
      00830C 1F 0E            [ 2]  587 	ldw	(0x0e, sp), x
                                    588 ; genGoto
      00830E CC 82 81         [ 2]  589 	jp	00108$
                                    590 ; genLabel
      008311                        591 00110$:
                                    592 ;	./src/main.c: 103: }
                                    593 ; genEndFunction
      008311 5B 0F            [ 2]  594 	addw	sp, #15
      008313 81               [ 4]  595 	ret
                                    596 	.area CODE
                                    597 	.area CONST
